...
def generate_launch_description():
	...
	ComponentInstance5_node = LifecycleNode(
		...
		package='gesturerecognition', node_executable='cameraDriver',
		remappings=[
			('image_P', 'ComponentInstance5/Image/image_P')
		],
	...
	ComponentInstance4_node = LifecycleNode(
		...
		package='gesturedetector', node_executable='GestureDetector',
		remappings=[
			('points_S', 'ComponentInstance4/Float32MultiArray/points_P'), ('command_P', 'ComponentInstance4/String/command_P')
		],
		parameters=[share_dir+'/launch/cfg/param.yaml'],
		output='screen',
		emulate_tty=True	# assure that RCLCPP output gets flushed
